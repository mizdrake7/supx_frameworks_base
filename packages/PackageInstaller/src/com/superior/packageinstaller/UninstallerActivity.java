...
import com.superior.packageinstaller.handheld.ErrorDialogFragment;
import com.superior.packageinstaller.handheld.UninstallAlertDialogFragment;

import java.util.List;

import static android.app.AppOpsManager.MODE_ALLOWED;
import static com.superior.packageinstaller.PackageUtil.getMaxTargetSdkVersionForUid;

/*
 * This activity presents UI to uninstall an application. Usually launched with intent
 * Intent.ACTION_UNINSTALL_PKG_COMMAND and attribute
 * com.superior.packageinstaller.PackageName set to the application package name
 */
public class UninstallerActivity extends Activity {
    ...
    private void showDialogFragment(@NonNull BottomDialogFragment fragment,
    ...
    public void startUninstallProgress(boolean keepData) {
        ...
        if (returnResult || mDialogInfo.callback != null || getCallingActivity() != null) {
