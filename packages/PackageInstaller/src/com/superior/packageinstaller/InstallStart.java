...
public class InstallStart extends Activity {
    ...
    private boolean isUidRequestingPermission(int uid) {
        ...
        for (final String packageName : packageNames) {
            ...
            if (packageInfo.requestedPermissions != null
                    && Arrays.asList(packageInfo.requestedPermissions).contains(Manifest.permission.REQUEST_INSTALL_PACKAGES)) {
                return true;
            }
        }
        return false;
     ...
     * {@link PackageInstaller.SessionParams#UID_UNKNOWN} if not available
     *
